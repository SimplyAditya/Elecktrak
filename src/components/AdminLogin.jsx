...
const AdminLogin = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col lg:flex-row'>
      <div className='h-1/2 lg:h-screen lg:w-4/6 flex items-center justify-start bg-black' style={{
          backgroundImage: `url(${backgroundImage})`,
          backgroundSize: 'contain',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center'
        }}>
        <h1 className='text-white text-5xl lg:text-9xl px-6 lg:px-20 font-bold font-serif'>Electrak</h1>
      </div>
      ...
      <div>
        ...
        <div className='w-full lg:w-4/5 p-6 lg:px-8'>
          ...
          <input placeholder='Username' className='p-2 ps-0 mb-4 w-full bg-transparent border-b-2 focus:outline-none text-white'/>
          ...
          <button className='w-full p-2 rounded-xl bg-themeBlue text-white'>Submit</button>
        </div>
